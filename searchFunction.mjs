...
function FilterList(t) {
  (this.root = t),
    ...
    (this.emptyState = this.root.find(".ncf-empty-state").clone(!0, !0)),
    this.root.find(".ncf-empty-state").remove(),
    this.initController(),
    this.container.find(".ncf-filter-item").each(
      function (t, e) {
    ...
    (this.maxPage = Math.max(
      0,
      Math.floor((this.itemList.length - 1) / this.perPage)
    )),
...
(FilterControllerSearch.prototype = {
  ...
  (FilterControllerChip.prototype = {
    ...
    setValue: function (t) {
      x = t
        ? this.element.addClass("ncf-selected")
        : this.element.removeClass("ncf-selected");
    },
    onChange: function () {},
  }),
  ...
  (FilterList.prototype = {
    ...
    updatePageIndicator: function () {
      (next = this.root.find(".ncf-next-page")),
        ...
        this.page == this.maxPage ? next.hide() : next.show(),
        0 == this.page ? prev.hide() : prev.show(),
      ...
      for (filter of ((equalset = !1), t)) {
        ...
        if ("equal" == filter.type) {
          if (
            ((equalset = !0),
            e &&
              (!filter.key in this.data ||
                this.data[filter.key] != filter.value))
          )
            return !1;
